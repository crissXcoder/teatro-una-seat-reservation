...
const badgeVariants = cva(
  "inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        default:
          "border-transparent bg-indigo-500/10 text-indigo-400 border-indigo-500/30",
        secondary:
        ...
        success:
          "border-transparent bg-emerald-500/10 text-emerald-400 border-emerald-500/30 animate-pulse",
